...
module.exports = (env, argv) => {
  ...
  output: {
    path: path.resolve(__dirname, 'nucash-server/public/admin-dist'),
    filename: 'bundle.js',
    publicPath: isDev ? '/' : '/admin-dist/',
    clean: true,
  },
  module: {
    rules: [
  ...
  plugins: [
    new HtmlWebpackPlugin({
      template: './nucash-server/public/admin.html',
      filename: 'index.html'
    }),
