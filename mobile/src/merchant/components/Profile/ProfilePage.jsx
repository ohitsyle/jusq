// src/merchant/components/Profile/ProfilePage.jsx
// Full page for merchant profile with personal info and password management
// MATCHING MOTORPOOL ADMIN DESIGN

import React, { useState } from 'react';

export default function ProfilePage({ merchantData }) {
  ...
  const getInitials = () => {
    ...
    const name = merchantData.businessName || merchantData.firstName || '';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <h2 style={{
            ...
            {merchantData?.businessName || `${merchantData?.firstName} ${merchantData?.lastName}`}
          </h2>
          <div style={{
      ...
      <div style={{ padding: '32px' }}>
        <div style={{
          ...
          <InfoField label="Merchant ID" value={merchantData?.merchantId} />
          <InfoField label="Business Name" value={merchantData?.businessName} />
          <InfoField label="Email Address" value={merchantData?.email} fullWidth />
          <InfoField
            label="Account Status"
            value={merchantData?.isActive ? 'Active' : 'Inactive'}
            highlight={merchantData?.isActive ? 'success' : 'error'}
          />
          <InfoField
            label="Verified"
            value={merchantData?.verified ? 'Yes' : 'No'}
            highlight={merchantData?.verified ? 'success' : 'warning'}
          />
        </div>
      </div>
    </div>
        ...
        <div style={{ maxWidth: '500px' }}>
          <div style={{
            ...
            <div style={{
              ...
              Check your email: {merchantData?.email}
            </div>
          </div>
