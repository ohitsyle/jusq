...
export default function ShuttlesList() {
  ...
  if (loading) {
    return <div className="text-center py-[60px]" style={{ color: theme.accent.primary }}>Loading shuttles...</div>;
  }
          ...
          <table className="w-full border-collapse text-[13px]">
            <thead>
              <tr style={{ background: isDarkMode ? 'rgba(255,212,28,0.1)' : 'rgba(59,130,246,0.1)' }}>
                <th className="text-left p-4 text-[11px] font-extrabold uppercase" style={{ color: theme.accent.primary, borderBottom: `2px solid ${isDarkMode ? 'rgba(255,212,28,0.3)' : 'rgba(59,130,246,0.3)'}` }}>Shuttle ID</th>
                <th className="text-left p-4 text-[11px] font-extrabold uppercase" style={{ color: theme.accent.primary, borderBottom: `2px solid ${isDarkMode ? 'rgba(255,212,28,0.3)' : 'rgba(59,130,246,0.3)'}` }}>Vehicle</th>
                <th className="text-left p-4 text-[11px] font-extrabold uppercase" style={{ color: theme.accent.primary, borderBottom: `2px solid ${isDarkMode ? 'rgba(255,212,28,0.3)' : 'rgba(59,130,246,0.3)'}` }}>Plate</th>
                <th className="text-left p-4 text-[11px] font-extrabold uppercase" style={{ color: theme.accent.primary, borderBottom: `2px solid ${isDarkMode ? 'rgba(255,212,28,0.3)' : 'rgba(59,130,246,0.3)'}` }}>Capacity</th>
                ...
                <th className="text-left p-4 text-[11px] font-extrabold uppercase" style={{ color: theme.accent.primary, borderBottom: `2px solid ${isDarkMode ? 'rgba(255,212,28,0.3)' : 'rgba(59,130,246,0.3)'}` }}>Current Driver</th>
            ...
            <tbody>
              {currentItems.map((shuttle) => (
                <tr key={shuttle._id} style={{ borderBottom: `1px solid ${theme.border.primary}` }}>
                  ...
                  <td style={{ padding: '16px' }}>
                    <select value={shuttle.status} onChange={(e) => handleStatusChange(shuttle, e.target.value)} style={{
                      ...
                      color: shuttle.status === 'available' ? '#22C55E' : shuttle.status === 'reserved' ? '#3B82F6' : shuttle.status === 'taken' ? (isDarkMode ? '#FBBF24' : '#F59E0B') : '#EF4444'
                    }}>
        ...
        <div onClick={() => setShowModal(false)} style={{
          ...
          <div onClick={(e) => e.stopPropagation()} style={{
            ...
            <form onSubmit={handleSubmit} style={{ padding: '24px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '12px', fontWeight: 700, color: theme.accent.primary, textTransform: 'uppercase' }}>Vehicle Type *</label>
              ...
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '12px', fontWeight: 700, color: theme.accent.primary, textTransform: 'uppercase' }}>Vehicle Model *</label>
              ...
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '12px', fontWeight: 700, color: theme.accent.primary, textTransform: 'uppercase' }}>Plate Number</label>
              ...
              <div style={{ marginBottom: '24px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '12px', fontWeight: 700, color: theme.accent.primary, textTransform: 'uppercase' }}>Capacity *</label>
