          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <button
                ...
                style={{
                  background: sysadConfig.deactivationScheduler?.enabled ? '#EF4444' : 'rgba(107,114,128,0.2)',
                  color: sysadConfig.deactivationScheduler?.enabled ? '#FFFFFF' : theme.text.secondary
                }}
                className="w-full py-3 rounded-xl font-semibold transition"
              >
                {sysadConfig.deactivationScheduler?.enabled ? 'Enabled' : 'Disabled'}
              </button>
            </div>
            <div>
              <label style={{ color: theme.text.secondary }} className="block text-xs font-semibold uppercase mb-2">
              ...
              <input
                ...
                disabled={!sysadConfig.deactivationScheduler?.enabled}
                style={{
